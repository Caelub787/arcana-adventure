...
-   **Campaign Map Tables**: `campaign_map_pins` (percentage-based coords, pin types, isShop flag), `shop_items` (attached to pins, with name/price/currency/stock/itemData).
