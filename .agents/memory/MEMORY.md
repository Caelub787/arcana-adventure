- [AA V3 spell features (built)](aa-v3-deferred-features.md) — NO-AI GM authoring via Crafted Spells "Pending requests" (no auto-popup) + V3 spell levels (shared/v3spells.ts), both implemented.
