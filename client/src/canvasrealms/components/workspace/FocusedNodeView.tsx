    ...
    >
      ...
      {node && (isCanvas || isMap) && (
        <button
          ...
          className="absolute top-2 right-2 z-40 h-7 w-7 rounded-full flex items-center justify-center bg-card/90 border border-border shadow-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
        >
